...
namespace CraftyServer.Core
{
    public class RegionFile
    {
        ...
        {
            debug(
                (new StringBuilder()).append("REGION ").append(s).append(" ").append(fileName.getName()).append("[").
                    append(i).append(",").append(j).append("] = ").append(s1).toString());
        }
        ...
        private void debug(string s, int i, int j, int k, string s1)
        {
            debug(
                (new StringBuilder()).append("REGION ").append(s).append(" ").append(fileName.getName()).append("[").
                    append(i).append(",").append(j).append("] ").append(k).append("B = ").append(s1).toString());
        }
        ...
        public bool isChunkSaved(int i, int j)
        {
