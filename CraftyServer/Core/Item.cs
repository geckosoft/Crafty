...
namespace CraftyServer.Core
{
    public class Item
    {
        ...
        public static Item plateDiamond =
            (new ItemArmor(55, 3, 3, 1)).setIconCoord(3, 1).setItemName("chestplateDiamond");
        ...
        protected Item(int i)
        {
            ...
            {
                java.lang.System.@out.println((new StringBuilder()).append("CONFLICT @ ").append(i).toString());
            }
        ...
        public virtual bool onItemUse(ItemStack itemstack, EntityPlayer entityplayer, World world, int i, int j, int k,
                                      int l)
        {
            return false;
        }

        public virtual float getStrVsBlock(ItemStack itemstack, Block block)
        {
            return 1.0F;
        }

        public virtual ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer)
        {
            return itemstack;
        }
        ...
        protected virtual Item setHasSubtypes(bool flag)
        {
            hasSubtypes = flag;
            return this;
        }
        ...
        protected virtual Item setMaxDamage(int i)
        {
            maxDamage = i;
            return this;
        }

        public virtual void hitEntity(ItemStack itemstack, EntityLiving entityliving)
        {
        }
        ...
        public virtual Item setItemName(string s)
        {
