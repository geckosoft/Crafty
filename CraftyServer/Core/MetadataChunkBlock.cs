namespace CraftyServer.Core
{
    public class MetadataChunkBlock
    {
        ...
        public bool func_692_a(int i, int j, int k, int l, int i1, int j1)
        {
            if (i >= field_956_b && j >= field_962_c && k >= field_961_d && l <= field_960_e && i1 <= field_959_f &&
                j1 <= field_958_g)
            {
                return true;
            }
            int k1 = 1;
            if (i >= field_956_b - k1 && j >= field_962_c - k1 && k >= field_961_d - k1 && l <= field_960_e + k1 &&
                i1 <= field_959_f + k1 && j1 <= field_958_g + k1)
            {
